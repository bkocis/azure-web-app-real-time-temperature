...
class EventHubReader {
  constructor(connectionString, consumerGroup) {
    this.connectionString = "<IoThowner connection string>"; // this is located in IoTHub "Share access policies" iothubowner connectionstring - it is not the device connection string
